...
Pod::Spec.new do |s|
  ...
  s.requires_arc = true
  # Or just: s.author    = "sujeking"
  # s.authors            = { "sujeking" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/sujeking"
  ...
  s.subspec 'HXSPopView' do |ss|
    ss.source_files = 'MyLib/HXSPopView/*.{h,m}'
    ss.resource_bundles = {
      'HXSPopView' => 'MyLib/HXSPopView/Resouces/*'
    }
  end
