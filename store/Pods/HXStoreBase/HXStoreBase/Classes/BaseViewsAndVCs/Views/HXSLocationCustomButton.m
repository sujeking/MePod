//
//  HXSLocationCustomButton.m
//  store
//
//  Created by chsasaw on 15/1/28.
...
@implementation HXSLocationCustomButton

+ (id)buttonWithType:(UIButtonType)buttonType
{
    HXSLocationCustomButton * button = [super buttonWithType:buttonType];
