...
@interface HXSCustomPickerView()<UIPickerViewDelegate, UIPickerViewDataSource>

@property (nonatomic, strong) UIPickerView *pickerView;
@property (nonatomic, strong) UIToolbar *picketToolbar;
@property (nonatomic, strong) NSArray * dataArray;
@property (nonatomic, strong) HXSCustomPickerViewBlock block;

@end

@implementation HXSCustomPickerView

- (id)initWithDataArray:(NSArray *)array block:(HXSCustomPickerViewBlock)block
{
...
+ (void)showWithStringArray:(NSArray *)array defaultValue:(NSString *)defaultValue toolBarColor:(UIColor *)color completeBlock:(HXSCustomPickerViewBlock)block
{
    ...
    HXSCustomPickerView * customView = [[HXSCustomPickerView alloc]initWithDataArray:array block:block];
    if(color) {
